...
class SplitScreen: SKScene
{
    ...
    func timeTwo()
    {
        if minuteTwo < 10 && secondTwo < 10 && milisecondTwo < 10
        {
            myTimeTwo.text = "0\(minuteTwo):0\(secondTwo).0\(milisecondTwo)"
        }
        if minuteTwo < 10 && secondTwo < 10 && milisecondTwo >= 10
        {
            myTimeTwo.text = "0\(minuteTwo):0\(secondTwo).\(milisecondTwo)"
        }
        if minuteTwo < 10 && secondTwo >= 10 && milisecondTwo < 10
        {
            myTimeTwo.text = "0\(minuteTwo):\(secondTwo).0\(milisecondTwo)"
        }
        if minuteTwo >= 10 && secondTwo < 10 && milisecondTwo < 10
        {
            myTimeTwo.text = "\(minuteTwo):0\(secondTwo).0\(milisecondTwo)"
        }
        if minuteTwo < 10 && secondTwo >= 10 && milisecondTwo >= 10
        {
            myTimeTwo.text = "0\(minuteTwo):\(secondTwo).\(milisecondTwo)"
        }
        if minuteTwo >= 10 && secondTwo < 10 && milisecondTwo >= 10
        {
            myTimeTwo.text = "\(minuteTwo):0\(secondTwo).\(milisecondTwo)"
        }
        if minuteTwo >= 10 && secondTwo >= 10 && milisecondTwo < 10
        {
            myTimeTwo.text = "\(minuteTwo):\(secondTwo).0\(milisecondTwo)"
        }
    }
